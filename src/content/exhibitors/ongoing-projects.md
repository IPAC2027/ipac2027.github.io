...
:::collapsible{title="Electron-Ion Collider"} 
...
:::collapsible{title="High Energy Effects Test Facility (proposed)"}
...
:::collapsible{title="NSLS-II Upgrade"}
...
:::collapsible{title="RIBF Upgrade Project"}
...
:::collapsible{title="Siam Photon Source II (SPS-II)"}
